...
public class TfaRememberMeEventHandlers : CookieAuthEventHandlers
{
    public TfaRememberMeEventHandlers(UserManager<GmIdentity> manager, SignInManager<GmIdentity> signin, IHttpContextAccessor accessor, IPassportService passportService, IOptions<JwtAuthOptions> jwtAuthOptions)
