...
public class KnownHeatmapBrush<TMetric> : MultiGradientBrush<TMetric> where TMetric : MetricDescriptor, new()
{
    public override int Modes => this.ModeColors.Count;
    public KnownHeatmapBrush(TMetric descriptor) : base(descriptor)
    {
