...
{
    public partial class ProfileCategories : BaseDataCollection<ProfileCategory, ProfileCategories, ProfileCache, ProfileContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public ProfileCategories(ProfileCache cache) : base(cache) { }
