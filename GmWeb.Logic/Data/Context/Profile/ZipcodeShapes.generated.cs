...
{
    public partial class ZipcodeShapes : BaseDataCollection<ZipcodeShape, ZipcodeShapes, ProfileCache, ProfileContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public ZipcodeShapes(ProfileCache cache) : base(cache) { }
