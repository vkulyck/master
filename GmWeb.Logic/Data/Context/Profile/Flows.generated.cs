...
{
    public partial class Flows : BaseDataCollection<Flow, Flows, ProfileCache, ProfileContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Flows(ProfileCache cache) : base(cache) { }

        public override DbSet<Flow> EntitySet => this.DataContext.Flows;
	}
}
