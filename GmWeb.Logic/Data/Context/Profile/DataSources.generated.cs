...
{
    public partial class DataSources : BaseDataCollection<DataSource, DataSources, ProfileCache, ProfileContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public DataSources(ProfileCache cache) : base(cache) { }

        public override DbSet<DataSource> EntitySet => this.DataContext.DataSources;
	}
}
