...
{
    public partial class ProfileContext : BaseDataContext<ProfileContext>
    {
        ...
        protected void ConfigureGeneratedEntities(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ConfigureGeneratedEntity<DataSource>();
            modelBuilder.ConfigureGeneratedEntity<Flow>();
            modelBuilder.ConfigureGeneratedEntity<FlowStep>();
        }
    }
}
