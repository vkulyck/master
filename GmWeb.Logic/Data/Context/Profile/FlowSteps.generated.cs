...
{
    public partial class FlowSteps : BaseDataCollection<FlowStep, FlowSteps, ProfileCache, ProfileContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public FlowSteps(ProfileCache cache) : base(cache) { }

        public override DbSet<FlowStep> EntitySet => this.DataContext.FlowSteps;
	}
}
