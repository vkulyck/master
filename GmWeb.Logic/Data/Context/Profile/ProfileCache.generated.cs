...
namespace GmWeb.Logic.Data.Context.Profile
{
    public partial class ProfileCache : BaseDataCache<ProfileCache, ProfileContext>
    {
        ...
        public ProfileCache(ProfileContext context) : base(context)
        {
            this.Initialize();
        }
        ...
        protected override void InitializeCollectionMap()
        {
		    ...
		    this.CollectionMap[typeof(DataSource)] = () => this.DataSources;
		    this.CollectionMap[typeof(DataSources)] = () => this.DataSources;

		    this.CollectionMap[typeof(Flow)] = () => this.Flows;
		    this.CollectionMap[typeof(Flows)] = () => this.Flows;

		    this.CollectionMap[typeof(FlowStep)] = () => this.FlowSteps;
		    this.CollectionMap[typeof(FlowSteps)] = () => this.FlowSteps;
		...
		public DataSources DataSources => _DataSources ?? (_DataSources = new DataSources(this));

		private Flows _Flows;
		public Flows Flows => _Flows ?? (_Flows = new Flows(this));

		private FlowSteps _FlowSteps;
		public FlowSteps FlowSteps => _FlowSteps ?? (_FlowSteps = new FlowSteps(this));
