...
{
    public partial class UserAccounts : BaseDataCollection<UserAccount, UserAccounts, AccountCache, AccountContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public UserAccounts(AccountCache cache) : base(cache) { }

        public override DbSet<UserAccount> EntitySet => this.DataContext.UserAccounts;
	}
}
