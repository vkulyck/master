...
if !exists("python_no_builtin_highlight")
  ...
  syn match pythonBuiltin       "\(\w\|\.\)\@<!\(min\|max\|id\|sum\|tuple\)\w\@!"
  " built-in functions
  ...
  syn keyword pythonBuiltin	help hex input int isinstance
  syn keyword pythonBuiltin	issubclass iter len list locals map
  syn keyword pythonBuiltin	next object oct open ord pow print
  syn keyword pythonBuiltin	property range repr reversed round set
  syn keyword pythonBuiltin	setattr slice sorted staticmethod str
  syn keyword pythonBuiltin	super type vars zip __import__
  " Python 2.6 only
  ...
  syn keyword pythonBuiltin     frame_block flush tag log
endif
...
if !exists("python_no_exception_highlight")
  ...
  syn match pythonExceptions	"[A-Za-z]\w\+Exception"
