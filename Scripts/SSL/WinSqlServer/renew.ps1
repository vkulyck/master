# First, try to use the newer cmdlets so that this can all be automated:
# https://docs.microsoft.com/en-us/powershell/module/rdmgmt/set-rdcertificate?view=windowsserver2022-ps
