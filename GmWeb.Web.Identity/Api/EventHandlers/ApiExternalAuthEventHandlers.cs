...
public class ApiExternalAuthEventHandlers : ExternalAuthEventHandlers
{
    public ApiExternalAuthEventHandlers(ApiUserManager manager, SignInManager<GmIdentity> signin, IHttpContextAccessor accessor, IOptions<JwtAuthOptions> jwtAuthOptions)
