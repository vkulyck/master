...
public class ApiTfaUserIdEventHandlers : TfaUserIdEventHandlers
{
    public ApiTfaUserIdEventHandlers(ApiUserManager manager, SignInManager<GmIdentity> signin, IHttpContextAccessor accessor, IOptions<JwtAuthOptions> jwtAuthOptions)
