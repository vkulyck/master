...
public class ApiApplicationAuthEventHandlers : ApplicationAuthEventHandlers
{
    public ApiApplicationAuthEventHandlers(ApiUserManager manager, SignInManager<GmIdentity> signin, IHttpContextAccessor accessor, IOptions<JwtAuthOptions> jwtAuthOptions)
