...
{
    public partial class Datasets : BaseDataCollection<Dataset, Datasets, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Datasets(DemographicsCache cache) : base(cache) { }

        public override DbSet<Dataset> EntitySet => this.DataContext.Datasets;
	}
}
