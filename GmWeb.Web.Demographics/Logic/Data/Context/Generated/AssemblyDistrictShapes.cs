...
{
    public partial class AssemblyDistrictShapes : BaseDataCollection<AssemblyDistrictShape, AssemblyDistrictShapes, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public AssemblyDistrictShapes(DemographicsCache cache) : base(cache) { }
