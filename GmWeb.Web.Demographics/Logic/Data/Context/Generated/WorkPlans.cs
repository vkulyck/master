...
{
    public partial class WorkPlans : BaseDataCollection<WorkPlan, WorkPlans, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public WorkPlans(DemographicsCache cache) : base(cache) { }

        public override DbSet<WorkPlan> EntitySet => this.DataContext.WorkPlans;
	}
}
