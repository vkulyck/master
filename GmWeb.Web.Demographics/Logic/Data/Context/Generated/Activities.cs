...
{
    public partial class Activities : BaseDataCollection<Activity, Activities, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Activities(DemographicsCache cache) : base(cache) { }

        public override DbSet<Activity> EntitySet => this.DataContext.Activities;
	}
}
