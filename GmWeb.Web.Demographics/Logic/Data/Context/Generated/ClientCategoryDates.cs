...
{
    public partial class ClientCategoryDates : BaseDataCollection<ClientCategoryDate, ClientCategoryDates, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public ClientCategoryDates(DemographicsCache cache) : base(cache) { }
