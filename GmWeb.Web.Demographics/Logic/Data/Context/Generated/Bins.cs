...
{
    public partial class Bins : BaseDataCollection<Bin, Bins, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Bins(DemographicsCache cache) : base(cache) { }

        public override DbSet<Bin> EntitySet => this.DataContext.Bins;
	}
}
