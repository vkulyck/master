...
{
    public partial class ClientServiceProfiles : BaseDataCollection<ClientServiceProfile, ClientServiceProfiles, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public ClientServiceProfiles(DemographicsCache cache) : base(cache) { }
