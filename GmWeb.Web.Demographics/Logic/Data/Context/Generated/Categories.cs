...
{
    public partial class Categories : BaseDataCollection<Category, Categories, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Categories(DemographicsCache cache) : base(cache) { }

        public override DbSet<Category> EntitySet => this.DataContext.Categories;
	}
}
