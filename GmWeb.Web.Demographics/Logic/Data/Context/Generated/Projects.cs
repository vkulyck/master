...
{
    public partial class Projects : BaseDataCollection<Project, Projects, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public Projects(DemographicsCache cache) : base(cache) { }

        public override DbSet<Project> EntitySet => this.DataContext.Projects;
	}
}
