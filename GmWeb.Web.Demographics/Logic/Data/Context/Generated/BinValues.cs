...
{
    public partial class BinValues : BaseDataCollection<BinValue, BinValues, DemographicsCache, DemographicsContext>
    {
		private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public BinValues(DemographicsCache cache) : base(cache) { }
